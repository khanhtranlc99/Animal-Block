...
public class GameBoardGenerator : Singleton<GameBoardGenerator>
{
	...
	{	
        ...
        blockPanelObj.transform.localScale = new Vector3(0.92f, 0.92f, 0.92f);
		
        blockPanelObj.GetComponent<RectTransform>().anchoredPosition  =  new Vector3(0f, -10f, 0f);
		//blockPanelObj.GetComponent<RectTransform>().position = new Vector3(0f, -10f, 0f);
